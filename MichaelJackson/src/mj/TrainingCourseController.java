...
public class TrainingCourseController {
	...
	public void getTrainingDetails(String courseID) {
		try {
			editCourse.getTrainingName().setText(trainingCourseGetterModel.getTrainingCourseDetails(courseID, 2));
			editCourse.getTrainingDesc().setText(trainingCourseGetterModel.getTrainingCourseDetails(courseID, 3));
			editCourse.getTrainerID().setText(trainingCourseGetterModel.getTrainingCourseDetails(courseID, 1));
			editCourse.getTrainingDate().setText(trainingCourseGetterModel.getTrainingCourseDetails(courseID, 4));
